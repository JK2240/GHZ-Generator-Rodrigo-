...
print("\n--- Stored Keys for Comparison ---")
print(f"Secure Alice Key: {alice_key_safe}")
print(f"Secure Bob Key: {bob_key_safe}")
print(f"Secure Charlie Key: {charlie_key_safe}")
print(f"Eavesdropped Alice Key: {alice_key_eavesdropped}")
print(f"Eavesdropped Bob Key: {bob_key_eavesdropped}")
print(f"Eavesdropped Charlie Key: {charlie_key_eavesdropped}")
