...
def run_simulation(num_bits=20, eavesdropped=False):
    ...
    # Define depolarization noise as requested
    ...
    for _ in range(num_bits):
        ...
        # Apply noise to the circuit and run with 100 repetitions
        result = simulator.run(circuit.with_noise(depolarize_noise), repetitions=100)

        # Extract the results (0 or 1). Note: Only the first repetition is used here.
    ...
    if final_alice_key == final_bob_key == final_charlie_key:
        ...
        print("[!] ALERT: Keys do not match! Noise in simulation.")
