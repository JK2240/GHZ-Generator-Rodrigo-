...
Original file is located at
    https://colab.research.google.com/drive/1baH6DNWgnkkQ6Q29po2mkyfdeOdSMpYL
"""
...
run_simulation(num_bits=15, eavesdropped=False)
run_simulation(num_bits=15, eavesdropped=True)